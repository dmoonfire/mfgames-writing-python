...
class ConvertToTextFilesProcess(writing.process.ConvertFilesProcess):
    pass
...
# class DocbookTextConvertProcess(writing.process.ConvertFilesProcess):
...
# class DocbookBBCodeHandler(DocbookHandler):
#     def write_heading(self, depth, text):
...
# class DocbookBBCodeConvertProcess(DocbookTextConvertProcess):
